"""
PS5E9 Competition - Multi-Model Ensemble with Fixed XGBoost Feature Importance
...
FIXED ISSUES:
- XGBoost feature importance extraction now handles both actual feature names and internal names (f0, f1, ...)
- Added proper handling for XGBoost Booster objects from xgboost.train()
- Enhanced logging to debug feature importance extraction
- Works with TabML's XGBoostModel wrapper that uses xgboost.train() internally
"""
